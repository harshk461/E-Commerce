...
const { registerUser, loginUser, forgotPassword, resetPassword, getUserByID, deleteUser, addToCart, removeFromCart, getCartDetails, AddNewAddress, GetAllAddress } = require('../controller/user.controller');
...
router.route("/remove-from-cart/:product_id/").put(isAuthenticated, removeFromCart);
